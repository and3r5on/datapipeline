#!/home/ander/Documentos/datapipeline/.env/bin/python3.9
# -*- coding: utf-8 -*-
...
class dataprocCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
          ...
          'instantiate_inline_workflow_template': ('parent', 'template', 'instance_id', 'request_id', ),
          'instantiate_workflow_template': ('name', 'version', 'instance_id', 'request_id', 'parameters', ),
